...
//
// TideMap.jsx a script for Adobe InDesign which demonstrates how to use JSXGetURL with 
    ...
    do {
        try {
            ...
            if (! (doc instanceof Document)) {
                reportErrorToUser(context, "The script needs an open document");
                break;
            }
            ...
            var tideMapCaptionFrame = doc.textFrames.itemByName("TideMapCaption");
            tideMapCaptionFrame.contents = "Tide Map for " + stationName;
            ...
            var tideMapDateRangeFrame = doc.textFrames.itemByName("TideMapDateRange");
            tideMapDateRangeFrame.contents = 
                "From:\t" + beginDate + "\r" + 
                "To:\t" + endDate + "\r" + 
            ...
            var tideMapRectangle = doc.rectangles.itemByName("TideMapParentRectangle");
            var xParentRectangleUpperLeft = tideMapRectangle.geometricBounds[1];
            var yParentRectangleUpperLeft = tideMapRectangle.geometricBounds[0];
            var xParentRectangleLowerRight = tideMapRectangle.geometricBounds[3];
            var yParentRectangleLowerRight = tideMapRectangle.geometricBounds[2];
            ...
            for (var idx = 0; idx < textFrames.length; idx++) { 
                ...
                if (textFrame.name.substring(0, 8) == "TideMap-") {
                    if (! keepBar) {
                        keepBar = textFrame;
                    }
                    else {
            ...
            for (var idx = 0; idx < context.tideData.length; idx++) {
                ...
                if (keepBar) {
                    if (idx == 0) {
                        tideMapFrame = keepBar;
                    }
                    else {
                        tideMapFrame = keepBar.duplicate();
                    }
                }
                else {
                    tideMapFrame = doc.textFrames.add();
                }
                tideMapFrame.name = "TideMap-" + idx;
                ...
                tideMapFrame.geometricBounds = [yBarUpperLeft, xBarUpperLeft, yBarLowerLeft, xBarLowerLeft];
            }
